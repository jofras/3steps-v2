...
//   {
//     name: "Hockey",
//     link: "https://hockey.3stepsathletics.com",
//     image: hockey3,
//   },
//   {
//     name: "Floorball",
//     link: "https://floorball.3stepsathletics.com",
//     image: floorball1,
//   },
// ];
...
//       {/* Intro Text */}
//       <div className="max-w-3xl text-center space-y-4 px-6 mt-10">
//         <p className="text-lg text-muted-foreground">
//           At 3steps Athletics, we’re passionate about youth development through
//           dynamic team sports. Explore our dedicated programs below.
//         </p>
//       </div>

//       {/* Sports Cards */}
//       <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-5xl px-6 py-12">
//         {sports.map((sport) => (
//           <SportCard
//             key={sport.name}
//             title={sport.name}
